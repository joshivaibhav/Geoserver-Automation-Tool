	...
	<div class="container-fluid">
	    <nav id="nav" style="background-color:#fbfbfb" class="z-depth-4">
			<div class="nav-wrapper">
			  <a href="#" class="brand-logo center" style="color:black; font-weight:100">Register</a>
			  <ul id="nav-mobile" class="left hide-on-med-and-down">
				<li><a href="#"style="color:black; font-weight:300">Main</a></li>
		...
		<div class="row">
			<div class="col s4"></div>
				<div class="col s4" id="card" >
					<div class="card z-depth-2 hoverable col s12 center-align" style="padding-top:40px;">
						<span class="card-title" style="font-size:2em;">New User</span>
					   ...
					   <br>
                             <div id = "cftr">Already Registered? -><a href="Login.jsp">Login Here</a></div>
